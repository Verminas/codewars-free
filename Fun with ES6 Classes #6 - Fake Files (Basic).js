...
class File {
  constructor(fullName, contents) {
    ...
    this._filename = this._fullName.slice(0, this._fullName.lastIndexOf('.'));
    this._extension = this._fullName.slice(this._fullName.lastIndexOf('.') + 1);
    this.arrayStrings = this.contents.split('\n');
    this.arrayLetters = this.contents.split('');
  ...
  gets() {
  if (this.currentLineIndex < this.arrayStrings.length) {
    const line = this.arrayStrings[this.currentLineIndex];
  ...
  getc() {
  if (this.currentLetterIndex < this.arrayLetters.length) {
    const letter = this.arrayLetters[this.currentLetterIndex];
